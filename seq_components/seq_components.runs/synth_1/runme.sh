...
HD_PWD='D:/B.Tech/RTL resources/verilog FPGA course Projects/seq_components/seq_components.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PISO_shift_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PISO_shift_reg.tcl
