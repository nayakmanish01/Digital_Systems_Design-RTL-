...
HD_PWD='D:/B.Tech/RTL_resources/verilog FPGA course Projects/seq_components2/seq_components2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_2_procc_moore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_2_procc_moore.tcl
