...
HD_PWD='D:/B.Tech/RTL_resources/verilog FPGA course Projects/Demo_IP/Demo_IP.runs/Mux_8_1_Mux_2_1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_8_1_Mux_2_1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_8_1_Mux_2_1_0_0.tcl
