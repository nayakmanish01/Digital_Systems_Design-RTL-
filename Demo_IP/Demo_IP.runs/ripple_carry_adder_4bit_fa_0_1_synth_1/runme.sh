...
HD_PWD='D:/B.Tech/RTL_resources/verilog FPGA course Projects/Demo_IP/Demo_IP.runs/ripple_carry_adder_4bit_fa_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_carry_adder_4bit_fa_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_carry_adder_4bit_fa_0_1.tcl
